...
| ✅ | Étape 5 : PWA un fichier, autotests | `index.html` v4, 45 ko, 35 autotests, 0 échec — 3 gestes, photo obligatoire, adresse et service compétent résolus en direct, signature mémorisée sur l'appareil |
